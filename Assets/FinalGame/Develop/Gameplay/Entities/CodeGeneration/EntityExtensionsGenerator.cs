...
namespace FinalGame.Develop.Gameplay.Entities.CodeGeneration
{
    public static class EntityExtensionsGenerator
    {
        private static Dictionary<EntityValues, Type> _entityValuesTypes = new Dictionary<EntityValues, Type>()
        {
            ...
            //ADV_FINAL
            {EntityValues.HealthBarPint, typeof (Transform)},
            {EntityValues.AimTransform, typeof(Transform)},
            {EntityValues.DetonateDistance , typeof(ReactiveVariable<float>)},
            {EntityValues.InstantAttackTrigger , typeof(ReactiveEvent)},
            
            {EntityValues.HealRequest , typeof(ReactiveEvent<float>)},
            {EntityValues.HealEvent , typeof(ReactiveEvent<float>)},
            {EntityValues.HealCondition , typeof(ICompositeCondition)},

            {EntityValues.IsBombPlaced, typeof(ReactiveEvent)}
        };
