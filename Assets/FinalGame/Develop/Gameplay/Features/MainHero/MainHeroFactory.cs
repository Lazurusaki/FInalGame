...
namespace FinalGame.Develop.Gameplay.Features.MainHero
{
    public class MainHeroFactory
    {
        ...
        public Entity CreateArcher(Vector3 position, MainHeroConfig config)
        {
        ...
        public Entity CreateCastle(Vector3 position, CastleConfig config, LevelConfig levelConfig)
        {
            Entity entity = _entityFactory.CreateCastle(position, config, levelConfig, Team);
